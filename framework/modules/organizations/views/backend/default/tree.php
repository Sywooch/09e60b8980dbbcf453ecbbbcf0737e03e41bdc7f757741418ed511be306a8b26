			...
			<div class="row">
				...
				<section class="col col-8">
					<? if($node->isNewRecord || empty($node->$iconAttribute)):
						...
						echo $form->field($node, $iconAttribute, ['template' => '{label} <label class="input" id="images"><a href="" id="thumb-image0" data-toggle="image"><img src="'.\Yii::$app->imageresize->getUrl(Yii::getAlias('@webroot' . $node->$iconAttribute), 200, 200, 'outbound', 0,
