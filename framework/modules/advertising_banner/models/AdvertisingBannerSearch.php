...
/**
 * AdvertisingBannerSearch represents the model behind the search form of `app\modules\advertising_banner\models\AdvertisingBanner`.
 */
class AdvertisingBannerSearch extends AdvertisingBanner
{
    /**
     * @inheritdoc
     */
